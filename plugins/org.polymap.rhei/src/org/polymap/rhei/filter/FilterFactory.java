...
import org.polymap.rhei.internal.filter.FilterProviderExtension;
...
public class FilterFactory {
    ...
    public static List<? extends IFilter> filtersForLayer( ILayer layer ) {
        ...
        for (FilterProviderExtension ext : FilterProviderExtension.allExtensions()) {
            try {
                ...
                List<IFilter> filters = ext.newFilterProvider().addFilters( layer );
                if (filters != null) {
    ...
    public static IFilter filterForLayer( ILayer layer, String filterId ) {
