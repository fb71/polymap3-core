...
export VMARGS='-Xverify:none -server -XX:+UseConcMarkSweepGC -XX:SoftRefLRUPolicyMSPerMB=100 -XX:NewRatio=3 -Xmx2048M -XX:MaxPermSize=128M -Dorg.eclipse.rwt.compression=true'
