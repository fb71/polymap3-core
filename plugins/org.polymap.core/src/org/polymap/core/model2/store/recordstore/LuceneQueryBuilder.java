...
class LuceneQueryBuilder {
     ...
     */
    protected String                    traversedPrefix;
    ...
    protected Query processExpression( String prefix, final BooleanExpression expression, Class<? extends Entity> resultType ) {
        ...
        for (Class<? extends LuceneExpressionHandler> handlerClass : handlers) {
            ...
            String currentPrefix = traversedPrefix;
            if (prefix != null && traversedPrefix != null) {
                traversedPrefix += RecordCompositeState.KEY_DELIMITER + prefix;
            }
            else if (prefix != null) {
                traversedPrefix = prefix;
            }
     ...
     */
    protected String prefixedFieldname( TemplateProperty prop ) {
        return traversedPrefix != null 
                ? traversedPrefix + RecordCompositeState.KEY_DELIMITER + simpleFieldname( prop )
                : simpleFieldname( prop );
    }
